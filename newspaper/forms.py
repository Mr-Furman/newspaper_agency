...
class NewspaperForm(forms.ModelForm):
    ...
    def clean_publishers(self):
        ...
        if not publishers or len(publishers) > 2:
            raise forms.ValidationError("Please choose from 1 to 2 publishers.")
    ...
    def clean_years_of_experience(self):
        ...
        if years_of_experience:
            if years_of_experience < 0:
                ...
                raise forms.ValidationError("Years of experience cannot be more than 50.")
